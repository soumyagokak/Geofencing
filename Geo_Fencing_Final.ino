...
//--------------------------------------------------------------
const String PHONE = "+918105909664";
//--------------------------------------------------------------
...
//--------------------------------------------------------------
float initialLatitude =15.822256;
float initialLongitude =74.489074;
...
void sendAlert()
{
  ...
  delay(1000);
  sim800.print("AT+CMGS=\"+918105909664\"\r");
  delay(1000);
